            ...
            <div class="card-body">
                <form method="post" action="{{ route('payment') }}" enctype="multipart/form-data">
                    ...
                    <div class="adress-wrap">
                        ...
                        <input type="text" id="adr" name="shipping_address" placeholder="Enter your address...">
                    </div>
                    <div class="city-wrap">
                        ...
                        <input type="text" id="city" name="shipping_city" placeholder="Enter your city...">
                    </div>
                    <div class="state-wrap">
                        ...
                        <input type="text" id="state" name="shipping_state" placeholder="Enter your state/region...">
                    </div>
                    <div class="zip-wrap">
                        ...
                        <input type="text" id="zip" name="shipping_zip" placeholder="Enter your zip...">
                    </div>
                    <input type="hidden" name="checkoutId" value={{$checkoutId}}>
                    <div class="btn-wrap">
                        <button type="submit" id="shipping-address-button" class="btn btn-primary">Continue to Payment</button>
                    </div>
                    @csrf
                </form>
            </div>
